...
class ScreenHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body:ValueListenableBuilder(valueListenable: scrollNotifier, 
       ...
       child: Stack(
         children: [
           ListView(children: [
            ...
            MainCardAndTitle(title:'Released in the past year' ,),
           MainCardAndTitle(title: 'Trending Now',),
           kHeight,
           NumberTitleCard(),
           kHeight,
           MainCardAndTitle(title: 'Tense Dreams',),
           kHeight,
           MainCardAndTitle(title:'South Indian Cinema' ,)
           ]),

          scrollNotifier.value==true? Container(
            width: double.infinity,height: 80,color: Colors.black.withOpacity(0.3),
            child: Column(
              children: [
                Row(
                  children: [Image.network("https://cdn-images-1.medium.com/max/1200/1*ty4NvNrGg4ReETxqU2N3Og.png",
                  width: 50,height: 50,),
                  Spacer(),
